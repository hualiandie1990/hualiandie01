...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [
            {"type_id": "37", "type_name": "4K专区"},
            {"type_id": "42", "type_name": "HD专区"},
    ...
    def detailContent(self, ids):
        ...
        content = '💖关注公众号【星视界Star】获取更多资源✨ShowStar&阿星为您介绍剧情💝' + content
        ...
        for line in kjson1['vod_play_list']:
            if line['player_info']['show'] == '自建线路':
                continue
            play_form += "星视界Star💖" + line['player_info']['show'] + '$$$'
            kurls = ""
        ...
        videos.append({
            ...
            "vod_year": year + '年',
            "vod_area": area,
            "vod_play_from": play_form.replace('(若黑屏请选择HD专区)', ' '),
