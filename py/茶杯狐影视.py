...
class Spider(Spider):
    ...
    def detailContent(self, ids):
        ...
        content = '💖关注公众号【星视界Star】获取更多资源✨阿星为您介绍剧情💝' + self.extract_middle_text(res,'<p class="detail-intro-text','</p>', 0)
        ...
        xianlu ="公众号星视界Star💖" + self.extract_middle_text(res, 'ul class="tab-box','</ul>',2, '<a href=".*?">(.*?)</a>')
